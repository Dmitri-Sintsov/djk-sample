...
function IconTest(options) {
    ...
    IconTest.runComponent = function($selector) {
        this.componentSelector = $selector;
        ko.applySelector(this);
    };

    IconTest.removeComponent = function($selector) {
        ko.cleanSelector(this);
    };

}(IconTest.prototype);

componentIoc.add('IconTest', function(options) {
    return new IconTest(options);
});
