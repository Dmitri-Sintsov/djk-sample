...
from djk_sample.views import renderer_test, tooltips_test, icon_test, UserChangeView
...
urlpatterns += [
    ...
    re_path(
        r'^icon-test/$', icon_test, name='icon_test',
        kwargs={'view_title': 'Icon UI test', 'allow_anonymous': True}
    ),
